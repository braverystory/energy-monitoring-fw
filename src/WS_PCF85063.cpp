...
{
	uint8_t second_alarm = decToBcd(time.second) & (~RTC_ALARM);
	uint8_t minute_alarm = decToBcd(time.minute) & (~RTC_ALARM);
	uint8_t hour_alarm = decToBcd(time.hour) & (~RTC_ALARM);
	// uint8_t day_alarm = decToBcd(time.day) & (~RTC_ALARM);
	// uint8_t dotw_alarm = decToBcd(time.dotw) & (~RTC_ALARM);
